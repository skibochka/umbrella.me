...
export class umbrella1617869823482 implements MigrationInterface {
    name = 'umbrella1617869823482'

    public async up(queryRunner: QueryRunner): Promise<void> {
      await queryRunner.query('CREATE TABLE "seeker_request" ("id" SERIAL NOT NULL, "volunteerId" integer NOT NULL, "seekerId" integer NOT NULL, "intention" character varying NOT NULL, CONSTRAINT "PK_92f9f8fb2535561d62fa86627ef" PRIMARY KEY ("id"))');
